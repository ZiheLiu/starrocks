...
public class PlanFragment extends TreeNode<PlanFragment> {
    ...
    private Set<SlotId> scanNodePartitionColumnSlotIds = Sets.newHashSet();
    ...
    public Set<SlotId> getScanNodePartitionColumnSlotIds() {
        return scanNodePartitionColumnSlotIds;
    }

    public void setScanNodePartitionColumnSlotIds(Set<SlotId> scanNodePartitionColumnSlotIds) {
        this.scanNodePartitionColumnSlotIds = scanNodePartitionColumnSlotIds;
    }
