...
class PushDownAggregateCollector extends OptExpressionVisitor<Void, AggregatePushDownContext> {
    ...
    private static final int SMALL_BROADCAST_JOIN_ROW_COUNT_UPPER_BOUND = 4096;
    ...
    public Void visitLogicalJoin(OptExpression optExpression, AggregatePushDownContext context) {
        ...
        AggregatePushDownContext leftContext = splitJoinAggregate(optExpression, context, 0, isSmallBroadcastJoin(optExpression));
    ...
    private boolean isSmallBroadcastJoin(OptExpression optExpression) {
        ...
        return rightRows <= sessionVariable.getBroadcastRowCountLimit() &&
                rightRows <= SMALL_BROADCAST_JOIN_ROW_COUNT_UPPER_BOUND;
    }
