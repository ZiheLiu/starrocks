...
public final class MetricRepo {
    ...
    public static final MetricWithLabelGroup<LongCounterMetric> COUNTER_QUERY_QUEUE_CATEGORY_SLOT_PENDING =
            new MetricWithLabelGroup<>("category",
                    () -> new LongCounterMetric("query_queue_slot_category_pending", MetricUnit.REQUESTS, ""));
    public static final MetricWithLabelGroup<LongCounterMetric> COUNTER_QUERY_QUEUE_CATEGORY_SLOT_RUNNING =
            new MetricWithLabelGroup<>("category",
                    () -> new LongCounterMetric("query_queue_slot_category_running", MetricUnit.REQUESTS, ""));
    public static final MetricWithLabelGroup<GaugeMetricImpl<Integer>> COUNTER_QUERY_QUEUE_CATEGORY_SLOT_WEIGHT =
            new MetricWithLabelGroup<>("category",
                    () -> new GaugeMetricImpl<>("query_queue_slot_category_weight", MetricUnit.REQUESTS, ""));
