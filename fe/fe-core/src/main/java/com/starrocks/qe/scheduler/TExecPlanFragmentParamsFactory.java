...
public class TExecPlanFragmentParamsFactory {
    ...
    public void toThriftFromCommonParams(TExecPlanFragmentParams result,
        ...
        result.params.setQuery_id(jobInfo.getQueryId());
        ...
        result.setIs_stream_pipeline(jobInfo.isEnableStreamPipeline());
        ...
        result.setQuery_globals(jobInfo.getQueryGlobals());
        if (isEnablePipeline) {
            result.setQuery_options(new TQueryOptions(jobInfo.getQueryOptions()));
        } else {
            result.setQuery_options(jobInfo.getQueryOptions());
        }
        ...
        if (context != null) {
            ...
            if (isEnablePipeline) {
                ...
                if (jobInfo.getResourceGroup() != null) {
                    result.setWorkgroup(jobInfo.getResourceGroup());
                }
