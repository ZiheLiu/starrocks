...
public class TExecPlanFragmentParamsFactory {
    ...
    public void toThriftFromCommonParams(TExecPlanFragmentParams result,
        ...
        result.params.setQuery_id(jobInformation.getQueryId());
        ...
        result.setIs_stream_pipeline(jobInformation.isEnableStreamPipeline());
        ...
        result.setQuery_globals(jobInformation.getQueryGlobals());
        if (isEnablePipeline) {
            result.setQuery_options(new TQueryOptions(jobInformation.getQueryOptions()));
        } else {
            result.setQuery_options(jobInformation.getQueryOptions());
        }
        ...
        if (context != null) {
            ...
            if (isEnablePipeline) {
                ...
                if (jobInformation.getResourceGroup() != null) {
                    result.setWorkgroup(jobInformation.getResourceGroup());
                }
    ...
    private void toThriftForUniqueParams(TExecPlanFragmentParams result,
        ...
        if (fragment instanceof MultiCastPlanFragment) {
            ...
            for (List<TPlanFragmentDestination> destinations : multiFragmentDestinations) {
                ...
                Preconditions.checkState(ndes.getDeprecated_server().getHostname().equals(instance.getAddress().getHostname()));
        ...
        result.params.setInstances_number(executionDAG.getNumInstancesOfAddr(instance.getAddress()));
