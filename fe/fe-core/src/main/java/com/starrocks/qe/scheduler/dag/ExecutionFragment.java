...
public class ExecutionFragment {
    ...
    public String getExplainString(int level) {
        ...
        builder.addMultipleChildren("INSTANCES", () -> instances.forEach(instance -> instance.buildExplainString(builder)));
    ...
    public Map<TNetworkAddress, List<FragmentInstance>> getAddrToInstances() {
    ...
    public long computeNumAddresses() {
        return instances.stream()
