...
public class ClientPool {
    ...
    static GenericKeyedObjectPoolConfig<FrontendService.Client> slotConfig = new GenericKeyedObjectPoolConfig<>();
    ...
    public static ConnectionPool<Poolable<FrontendService.Client>> slotPool =
