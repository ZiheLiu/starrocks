  ...
  INSTANCES
    INSTANCE(4-F01#0)
      DESTINATIONS
        ...
        1-F00#0,2-F00#1,3-F00#2,1-F00#0
      BE: 10002
      SCAN RANGES
        BUCKET SEQUENCES
          17,2,5,8,11,14
...
PLAN FRAGMENT 3(F04)
  ...
  INSTANCES
    INSTANCE(7-F04#0)
      DESTINATIONS
        5-F01#1,6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1
        6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0,5-F01#1,6-F01#2,4-F01#0
      BE: 10002
      SCAN RANGES
        8:OlapScanNode
