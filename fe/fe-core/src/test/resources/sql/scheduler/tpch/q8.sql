  ...
  INSTANCES
    INSTANCE(7-F01#0)
      DESTINATIONS
        ...
        6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0,5-F00#1,6-F00#2,4-F00#0
      BE: 10003
      SCAN RANGES
        BUCKET SEQUENCES
          0
...
PLAN FRAGMENT 5(F03)
  ...
  INSTANCES
    INSTANCE(11-F03#0)
      DESTINATIONS
        8-F02#0,9-F02#1,10-F02#2,8-F02#0,9-F02#1,10-F02#2,8-F02#0,9-F02#1,10-F02#2,8-F02#0
        9-F02#1,10-F02#2
      BE: 10002
      SCAN RANGES
        BUCKET SEQUENCES
...
PLAN FRAGMENT 6(F16)
  ...
  INSTANCES
    INSTANCE(14-F16#0)
      DESTINATIONS
        13-F03#2,11-F03#0,12-F03#1,13-F03#2,11-F03#0,12-F03#1,13-F03#2,11-F03#0,12-F03#1,13-F03#2
