...
public class IvmDeltaJoinRuleTest {
    ...
    @Test
    public void testTransformLeftOuterJoinUnsupported(@Mocked OlapTable leftTable,
                                                      @Mocked OlapTable rightTable) {
        assertUnsupportedJoinRewrite(leftTable, rightTable, JoinOperator.LEFT_OUTER_JOIN);
    }

    @Test
    public void testTransformLeftAntiJoinUnsupported(@Mocked OlapTable leftTable,
                                                     @Mocked OlapTable rightTable) {
        assertUnsupportedJoinRewrite(leftTable, rightTable, JoinOperator.LEFT_ANTI_JOIN);
    }

    @Test
    public void testTransformLeftSemiJoinUnsupported(@Mocked OlapTable leftTable,
                                                     @Mocked OlapTable rightTable) {
        assertUnsupportedJoinRewrite(leftTable, rightTable, JoinOperator.LEFT_SEMI_JOIN);
    }
