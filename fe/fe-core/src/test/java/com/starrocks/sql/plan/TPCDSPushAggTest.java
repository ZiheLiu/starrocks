...
public class TPCDSPushAggTest extends TPCDS1TTestBase {
    ...
    public void testTPCDSUnPushDownAgg(String sql, int orig, int auto, int force, int mid, int high) throws Exception {
        String origPlan = check(-1, sql, orig);
        check(0, sql, auto, false, origPlan);
        check(1, sql, force, false, origPlan);
        check(2, sql, mid, false, origPlan);
        check(3, sql, high, false, origPlan);
    }
    ...
    private String getPlan(int cboPushDownAggregateMode, String sql) throws Exception {
        connectContext.getSessionVariable().setCboPushDownAggregateMode(cboPushDownAggregateMode);
        sql = getTPCDS(sql);
        return getLogicalFragmentPlan(sql);
    }
    ...
    private static Stream<Arguments> testPushDownProvider() {
        ...
        Arguments[] cases = new Arguments[] {
                ...
                Arguments.of("Q05", 8, 14, true, 14, true, 14, true, 14, true),
                ...
                Arguments.of("Q24_1", 6, 6, false, 7, true, 8, true, 8, true),
                Arguments.of("Q24_2", 6, 6, false, 7, true, 8, true, 8, true),
                Arguments.of("Q25", 2, 2, false, 4, true, 4, true, 4, true),
                Arguments.of("Q29", 2, 2, false, 4, true, 4, true, 4, true),
                Arguments.of("Q30", 4, 4, false, 6, true, 4, false, 4, false),
                Arguments.of("Q31", 4, 8, true, 8, true, 8, true, 8, true),
                Arguments.of("Q33", 8, 11, true, 14, true, 14, true, 14, true),
                Arguments.of("Q37", 2, 4, true, 4, true, 4, true, 4, true),
                Arguments.of("Q38", 8, 14, true, 11, true, 14, true, 11, true),
                ...
                Arguments.of("Q45", 6, 6, false, 8, true, 8, true, 8, true),
                Arguments.of("Q46", 2, 2, false, 4, true, 2, false, 2, false),
                Arguments.of("Q47", 2, 2, true, 4, true, 4, true, 4, true),
                Arguments.of("Q49", 8, 8, false, 14, true, 14, true, 14, true),
                ...
                Arguments.of("Q54", 9, 11, true, 16, true, 13, true, 16, true),
                ...
                Arguments.of("Q71", 2, 2, false, 4, true, 8, true, 8, true),
                ...
                Arguments.of("Q80", 8, 14, true, 14, true, 14, true, 14, true),
                Arguments.of("Q81", 4, 4, false, 6, true, 4, false, 4, false),
                Arguments.of("Q82", 2, 4, true, 4, true, 4, true, 4, true),
                Arguments.of("Q83", 6, 12, true, 12, true, 12, true, 12, true),
                Arguments.of("Q87", 8, 14, true, 11, true, 14, true, 11, true),
                Arguments.of("Q89", 2, 2, false, 4, true, 4, true, 4, true),
                Arguments.of("Q91", 2, 4, true, 4, true, 2, false, 4, true),
                Arguments.of("Q93", 2, 2, false, 4, true, 4, true, 4, true),
                Arguments.of("Q97", 6, 6, false, 8, true, 10, true, 8, true),
