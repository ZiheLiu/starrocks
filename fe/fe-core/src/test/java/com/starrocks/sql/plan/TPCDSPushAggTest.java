...
public class TPCDSPushAggTest extends TPCDS1TTestBase {
    ...
    private static Stream<Arguments> testPushDownProvider() {
        ...
        Arguments[] cases = new Arguments[] {
                ...
                Arguments.of("Q05", 8, 14, true, 16, true, 16, true, 16, true),
                ...
                Arguments.of("Q15", 2, 2, true, 4, true, 4, true, 4, true),
                ...
                Arguments.of("Q54", 9, 11, true, 16, true, 11, true, 16, true),
                ...
                Arguments.of("Q80", 8, 14, true, 8, false, 8, false, 8, false),
