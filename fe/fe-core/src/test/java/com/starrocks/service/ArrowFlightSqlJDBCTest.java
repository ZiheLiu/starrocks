...
public class ArrowFlightSqlJDBCTest {
    static final String DB_URL = "jdbc:arrow-flight-sql://127.0.0.1:9408?useServerPrepStmts=false"
            + "&cachePrepStmts=false&useSSL=false&useEncryption=false";
    ...
    private static void testNative() {
        ...
        final Location clientLocation = Location.forGrpcInsecure("127.0.0.1", 9408);
        FlightSqlClient client = new FlightSqlClient(FlightClient.builder(allocator, clientLocation).build());
    ...
    private static void testJDBC() {
        ...
        try {
            ...
            executeQuery(stmt, "set enable_profile = true;");
