...
public class UtFrameUtils {
    ...
    private static <R> R getPlan(ConnectContext connectContext, String originStmt,
    ...
    public static Pair<String, ExecPlan> getPlanAndFragment(ConnectContext connectContext, String originStmt)
            throws Exception {
        return getPlan(connectContext, originStmt,
                (context, statementBase, execPlan) -> new Pair<>(printPhysicalPlan(execPlan.getPhysicalPlan()), execPlan));
    }
    ...
    public static Pair<String, DefaultScheduler> getPlanAndStartScheduling(ConnectContext connectContext, String originStmt)
            throws Exception {
    ...
    public static DefaultScheduler getScheduler(ConnectContext connectContext, String originStmt) throws Exception {
        return getPlan(connectContext, originStmt, UtFrameUtils::createScheduler);
    }

    private static DefaultScheduler createScheduler(ConnectContext context, StatementBase statementBase, ExecPlan execPlan) {
