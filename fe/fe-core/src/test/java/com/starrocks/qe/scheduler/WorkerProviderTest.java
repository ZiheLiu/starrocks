...
public class WorkerProviderTest {
    ...
    @Test
    public void testAcceptSlotRequirement() {
        WorkerProvider workerProvider = new WorkerProvider(id2Backend, id2ComputeNode, id2Backend, id2ComputeNode, true);

        SharingSlotRequirement emptySlotRequirement = new SharingSlotRequirement.Builder().build();
        workerProvider.acceptSlotRequirement(emptySlotRequirement);
        for (long id = 0; id < 15; id++) {
            ComputeNode worker = workerProvider.getWorker(id);
        ...
        SharingSlotRequirement slotRequirement = new SharingSlotRequirement.Builder().add(0L, 1).add(10L, 1).build();
