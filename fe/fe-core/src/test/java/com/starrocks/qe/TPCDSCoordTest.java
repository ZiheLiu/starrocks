...
public class TPCDSCoordTest extends TPCDSPlanTestBase {
    ...
    public void testQuery20() throws Exception {
        ...
        ExecutionFragment params = coord.getIdToFragment().get(topFragmentId);
        Assert.assertEquals(params.getRuntimeFilterParams().id_to_prober_params.get(1).size(), 10);
    }
    ...
    public void testSubQueryExtractedFromQ5() throws Exception {
        ...
        for (ExecutionFragment execFragment : coord.getIdToFragment().values()) {
