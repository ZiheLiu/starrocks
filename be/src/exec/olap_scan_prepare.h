...
public:
    ChunkPredicateBuilder(const OlapScanConjunctsManagerOptions& opts, CompoundNodeType type, std::vector<E> exprs,
                          bool allow_partial_normalized);

    StatusOr<bool> parse_conjuncts();

    StatusOr<PredicateTreeNode> get_predicate_tree_root(PredicateParser* parser, ColumnPredicatePtrs& col_preds_owner);
