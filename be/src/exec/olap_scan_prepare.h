...
public:
    ...
    using ConjunctiveExprContexts = std::vector<std::pair<ExprContext*, const SlotDescriptor*>>;
    using DisjunctiveExprContexts = std::vector<ConjunctiveExprContexts>;
...
private:
    ...
    std::vector<DisjunctiveExprContexts> disjuncts;
...
public:
    ...
    Status get_disjunctive_predicates(PredicateParser* parser,
                                      std::vector<std::unique_ptr<DisjunctivePredicates>>* preds);
    ...
    Status parse_conjuncts(bool scan_keys_unlimited, int32_t max_scan_key_num,
                           bool enable_column_expr_predicate = false, bool enable_or_predicate = false);
...
private:
    ...
    Status build_disjunctive_predicates();
};
