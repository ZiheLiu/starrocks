...
void WorkGroup::init() {
    ...
    _scan_sched_entity.set_queue(std::make_unique<CFSScanTaskQueue>(config::pipeline_scan_thread_pool_queue_size));
    _connector_scan_sched_entity.set_queue(
            std::make_unique<CFSScanTaskQueue>(config::pipeline_scan_thread_pool_queue_size));
}
