...
class MemoryScratchSinkOperator final : public OperatorHelper<MemoryScratchSinkOperator> {
public:
    MemoryScratchSinkOperator(OperatorFactory* factory, int32_t id, int32_t plan_node_id, int32_t driver_sequence,
            ...
            : OperatorHelper(factory, id, "memory_scratch_sink", plan_node_id, false, driver_sequence),
