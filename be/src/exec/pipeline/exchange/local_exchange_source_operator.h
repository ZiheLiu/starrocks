...
class LocalExchangeSourceOperator final : public SourceOperatorHelper<LocalExchangeSourceOperator> {
...
public:
    LocalExchangeSourceOperator(OperatorFactory* factory, int32_t id, int32_t plan_node_id, int32_t driver_sequence,
            ...
            : SourceOperatorHelper(factory, id, "local_exchange_source", plan_node_id, true, driver_sequence),
