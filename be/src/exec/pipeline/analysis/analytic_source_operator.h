...
class AnalyticSourceOperator : public SourceOperatorHelper<AnalyticSourceOperator> {
public:
    AnalyticSourceOperator(OperatorFactory* factory, int32_t id, int32_t plan_node_id, int32_t driver_sequence,
            ...
            : SourceOperatorHelper(factory, id, "analytic_source", plan_node_id, false, driver_sequence),
