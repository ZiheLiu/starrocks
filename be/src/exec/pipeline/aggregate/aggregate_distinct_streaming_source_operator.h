...
class AggregateDistinctStreamingSourceOperator : public SourceOperatorHelper<AggregateDistinctStreamingSourceOperator> {
public:
    AggregateDistinctStreamingSourceOperator(OperatorFactory* factory, int32_t id, int32_t plan_node_id,
            ...
            : SourceOperatorHelper(factory, id, "aggregate_distinct_streaming_source", plan_node_id, false,
                                   driver_sequence),
