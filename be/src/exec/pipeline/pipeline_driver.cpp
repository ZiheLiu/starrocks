...
Status PipelineDriver::prepare(RuntimeState* runtime_state) {
    ...
    _submit_lock_timer = ADD_TIMER(_runtime_profile, "MySubmitLockTimer");
    _take_lock_timer = ADD_TIMER(_runtime_profile, "MyTakeLockTimer");
    _take_timer = ADD_TIMER(_runtime_profile, "MyTakeTimer");
