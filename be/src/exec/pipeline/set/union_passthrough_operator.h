...
class UnionPassthroughOperator final : public OperatorHelper<UnionPassthroughOperator> {
public:
    struct SlotItem {
        SlotId slot_id;
        size_t ref_count;
    ...
    UnionPassthroughOperator(OperatorFactory* factory, int32_t id, int32_t plan_node_id, int32_t driver_sequence,
            ...
            : OperatorHelper(factory, id, "union_passthrough", plan_node_id, false, driver_sequence),
