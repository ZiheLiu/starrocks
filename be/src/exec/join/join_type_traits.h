...
#define APPLY_JOIN_KEY_CONSTRUCTOR_UNARY_TYPE(M) \
    ...
    M(SERIALIZED_FIXED_SIZE_DECIMAL256)          \
...
#define APPLY_JOIN_HASH_MAP_METHOD_UNARY_TYPE(M) \
    ...
    M(LINEAR_CHAINED_SET_DECIMAL256)             \
...
REGISTER_KEY_CONSTRUCTOR(SERIALIZED_FIXED_SIZE, TYPE_DECIMAL256, KeyConstructorForSerializedFixedSize<TYPE_DECIMAL256>,
                         SERIALIZED_FIXED_SIZE_DECIMAL256);
...
REGISTER_JOIN_MAP_METHOD_TYPE(BUCKET_CHAINED, TYPE_DECIMAL256, BucketChainedJoinHashMap, BUCKET_CHAINED_DECIMAL256);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED, TYPE_DECIMAL256, LinearChainedJoinHashMap, LINEAR_CHAINED_DECIMAL256);
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED_SET, TYPE_DECIMAL256, LinearChainedJoinHashSet,
                              LINEAR_CHAINED_SET_DECIMAL256);
