...
#define APPLY_JOIN_HASH_MAP_METHOD_UNARY_TYPE(M) \
    ...
    M(LINEAR_CHAINED2_VARCHAR)                   \
                                                 \
    M(LINEAR_CHAINED2_SET_INT)                   \
    M(LINEAR_CHAINED2_SET_BIGINT)                \
    M(LINEAR_CHAINED2_SET_LARGEINT)              \
    M(LINEAR_CHAINED2_SET_FLOAT)                 \
    M(LINEAR_CHAINED2_SET_DOUBLE)                \
    M(LINEAR_CHAINED2_SET_DATE)                  \
    M(LINEAR_CHAINED2_SET_DATETIME)              \
    M(LINEAR_CHAINED2_SET_DECIMALV2)             \
    M(LINEAR_CHAINED2_SET_DECIMAL32)             \
    M(LINEAR_CHAINED2_SET_DECIMAL64)             \
    M(LINEAR_CHAINED2_SET_DECIMAL128)            \
    M(LINEAR_CHAINED2_SET_VARCHAR)
...
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_INT, LinearChainedJoinHashSet2, LINEAR_CHAINED2_SET_INT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_BIGINT, LinearChainedJoinHashSet2, LINEAR_CHAINED2_SET_BIGINT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_LARGEINT, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_LARGEINT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_FLOAT, LinearChainedJoinHashSet2, LINEAR_CHAINED2_SET_FLOAT);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DOUBLE, LinearChainedJoinHashSet2, LINEAR_CHAINED2_SET_DOUBLE);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DATE, LinearChainedJoinHashSet2, LINEAR_CHAINED2_SET_DATE);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DATETIME, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_DATETIME);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DECIMALV2, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_DECIMALV2);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DECIMAL32, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_DECIMAL32);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DECIMAL64, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_DECIMAL64);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_DECIMAL128, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_DECIMAL128);
REGISTER_JOIN_MAP_METHOD_TYPE(LINEAR_CHAINED2_SET, TYPE_VARCHAR, LinearChainedJoinHashSet2,
                              LINEAR_CHAINED2_SET_VARCHAR);
