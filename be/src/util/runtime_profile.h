...
private:
    ...
    using CounterMap = phmap::flat_hash_map<std::string, std::pair<Counter*, std::string>>;
    ...
    using ChildCounterMap = phmap::flat_hash_map<std::string, std::set<std::string>>;
    ...
    using ChildMap = phmap::flat_hash_map<std::string, RuntimeProfile*>;
    ChildMap _child_map;
