...
Status ExecEnv::_init(const std::vector<StorePath>& store_paths) {
    ...
    _connector_scan_executor_without_workgroup =
            new workgroup::ScanExecutor(std::move(connector_scan_worker_thread_pool_without_workgroup),
                                        std::make_unique<workgroup::CFSScanTaskQueue>());
