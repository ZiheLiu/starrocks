...
struct CanPushDownVisitor {
    bool operator()(const PredicateTreeColumnNode& node) const { return parent->can_pushdown(node.col_pred()); }
...
bool PredicateParser::can_pushdown(const PredicateTreeNode& pred_tree) const {
