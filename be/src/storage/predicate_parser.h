...
public:
    ...
    virtual ColumnPredicate* parse_thrift_cond(const FilterCondition& condition) const = 0;
...
protected:
    static ColumnPredicate* create_column_predicate(const TCondition& condition, TypeInfoPtr& type_info,
                                                    ColumnId index);
    static ColumnPredicate* create_column_predicate(const FilterCondition& condition, TypeInfoPtr& type_info,
                                                    ColumnId index);
};
...
public:
    ...
    ColumnPredicate* parse_thrift_cond(const FilterCondition& condition) const override;
